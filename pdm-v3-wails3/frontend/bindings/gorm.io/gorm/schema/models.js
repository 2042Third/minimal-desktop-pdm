...
export class Field {
    ...
    constructor($$source = {}) {
        ...
        if (!("AutoCreateTime" in $$source)) {
             ...
             * @type {TimeType}
             */
            this["AutoCreateTime"] = (/** @type {TimeType} */(0));
        }
        if (!("AutoUpdateTime" in $$source)) {
             ...
             * @type {TimeType}
             */
            this["AutoUpdateTime"] = (/** @type {TimeType} */(0));
        }
...
export class Relationships {
    ...
    constructor($$source = {}) {
        ...
        if (!("Relations" in $$source)) {
            /**
             * @member
             * @type {{ [_: string]: Relationship | null }}
             */
            this["Relations"] = {};
        }
        if (!("EmbeddedRelations" in $$source)) {
            /**
             * @member
             * @type {{ [_: string]: Relationships | null }}
             */
