...
var root_1 = template(`<li class="svelte-1vlgswv"> </li>`);
var root_3 = template(`<div class="error svelte-1vlgswv"> </div>`);
var root_5 = template(`<th class="svelte-1vlgswv"> </th>`);
var root_7 = template(`<td class="svelte-1vlgswv"> </td>`);
...
function _page($$anchor, $$props) {
  ...
  var node = child(div_6);
  {
    ...
    if_block(node, ($$render) => {
      if (results) $$render(consequent_2);
    });
  }
  reset(div_6);
  reset(div_1);
