...
class QueryResult {
  ...
  static createFrom($$source = {}) {
    const $$createField0_0 = $$createType0$5;
...
class Expr {
   ...
   */
  static createFrom($$source = {}) {
    const $$createField1_0 = $$createType0$4;
    let $$parsedSource = typeof $$source === "string" ? JSON.parse($$source) : $$source;
...
class StructField {
   ...
   */
  static createFrom($$source = {}) {
    const $$createField5_0 = $$createType0$3;
    let $$parsedSource = typeof $$source === "string" ? JSON.parse($$source) : $$source;
...
class Field {
   ...
   */
  static createFrom($$source = {}) {
    const $$createField2_0 = $$createType0$2;
    const $$createField3_0 = $$createType0$2;
...
class Schema {
  ...
  static createFrom($$source = {}) {
    ...
    const $$createField4_0 = $$createType0$2;
    const $$createField5_0 = $$createType19;
    const $$createField6_0 = $$createType0$2;
...
const $$createType0$1 = ne.Array(ne.Any);
...
const $$createType0 = ne.Map(ne.Any, ne.Any);
